            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../foto/logopondok.png" class="user-image" alt="User Image">
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../foto/logopondok.png" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
              <p>SELAMAT DATANG</p>
              <a href="index.aspx"><i class="fa fa-circle text-success"></i><?php echo"$_SESSION[nama]"; ?></a>
            </div>
          </div>
          <!-- search form -->
     ...
     <script>
		...
		$(document).ready(function(){
			$("#upload").click(function(){
				...
				var id_daftar = ambilId("id_daftar").value; // Ambil nilai id_buktidokumen

				if (file!="") {
					var formdata = new FormData();
					formdata.append("file", file);
					formdata.append("keterangan", keterangan); // Tambahkan keterangan ke FormData
					formdata.append("id_daftar", id_daftar); 
