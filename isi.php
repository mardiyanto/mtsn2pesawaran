        ...
        <div class='row g-5 justify-content-center mb-5'>
            ...
            <div class='col-lg-4 col-md-6 wow fadeInUp' data-wow-delay='0.5s'>
                <div class='bg-light text-center h-100 p-5'>
                    ...
                    <a class='btn btn-primary px-4' href='$tt[alias]' target='blank'>Direction <i class='fa fa-arrow-right ms-2'></i></a>
                </div>
            </div>
        </div>
        <div class='row mb-5'>
...
elseif($_GET['aksi']=='lupapassword'){
    ...
    <div class='container-fluid py-5'>
        <div class='container'>
            <div class='row g-5'>
                <div class='col-lg-6 wow fadeInUp' data-wow-delay='0.1s'>
                    <h1 class='display-6 mb-4'>Reset Password Sistem Untuk Login Sistem</h1>
                    <p>silahkan reset di sistem kami, Lalu login Kembali Kesistem Kami</p>
                ...
                <div class='col-lg-6 wow fadeInUp' data-wow-delay='0.5s'>
                    ...
                    <div class='row g-3'>
                       ...
                       <div class='col-6 text-center'>
                            <a class='btn btn-primary w-100 py-3' href='utama.php?aksi=login'>Login Now</a>
                        </div>
                    </div>
                    </form>
                </div>
